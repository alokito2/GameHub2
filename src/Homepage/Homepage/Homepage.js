  ...
  return (
    <React.Fragment>
      ...
      <div className="about-section">
        <h2>About</h2>
        <p> GameHub is a website that offers a diverse collection of online games to entertain and engage users of all ages. With a user-friendly interface, the website provides easy access to a wide range of games, including puzzles, arcade classics, strategy games, and more. Users can explore different game categories, choose their favorites, and start playing instantly without the need for downloads or installations. The website aims to provide a fun and immersive gaming experience, allowing players to relax, challenge themselves, and enjoy their leisure time. Whether you're a casual gamer or a dedicated gaming enthusiast, GameHub has something to offer for everyone.</p>
      </div>
      {/* Heading of Cards */}
      ...
      <div className="copyright">
        <h3>&copy;Copyright GameHub {new Date().getFullYear()}</h3>
      </div>
    </React.Fragment>
  );
}
